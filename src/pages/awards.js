...
const awardData = [
	...
	},
	{
		...
		awards: [
			...
			"Most Outstanding Digital Communications Project (Gold award) - “TrainLK” 5.",
			"Most Outstanding Public Relations Effort via Print Media (Gold award) - “Marathon TowardsGreenery”",
	...
	},
	{
		...
		awards: [
			...
			"Rotaract Lifetime Achievement Award- Rtr. PP. Himantha Alahakoon",
	...
	{
		heading: "RI year 2023-24",
		subHeading: "Awards at the 34th Rotaract District Assembly",
		awards: [
			"Most Outstanding Annual Report 2023-24",
			"Gold Distinction: Successful Completion of the year and Creating a Ripple Inspiration as a Youth for All",
			"Gold Award: Most Outstanding Cluster Project Athwela",
			"President of the Month February: Rtr. Lakshani Pathiranage",
			"Secretary of the Month February: Rtr. Danushi Suriyanchchi",
			"Spirit of Service Award: Rtr. Nisansala Karunathilake",
			"Award for Hosting Lanka Trails",
			"RotaractLife Time Award: Rtr. PP Paveen Perera",
			"Bronze Award: Most Outstanding Inter-Zonal Initiative Project Compagna",
			"Merit Award: Most Outstanding Overall Membership Development and Retention Effort",
			"Merit Award: Most Outstanding Club for Continuous Twin Club Agreement",
			"Merit Award: Most Outstanding Newly Established Twin Club Agreement",
			"Rotaract Lifetime Achievement Award- Rtr. PP. Paveen Perera",
		],
	},
	// {
	// 	heading: "",
